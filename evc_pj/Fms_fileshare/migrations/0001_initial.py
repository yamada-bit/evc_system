...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='TtSharedFile',
            fields=[
                ('shared_id', models.CharField(max_length=20, primary_key=True, serialize=False)),
                ('shared_name', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('shared_type', models.IntegerField(default=0)),
            ...
            options={
                'verbose_name': '共有ファイル情報',
                'verbose_name_plural': '共有ファイル情報',
