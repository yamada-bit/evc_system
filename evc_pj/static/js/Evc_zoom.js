...
* onBlur : カンマ削除処理実施
*/
// let elm = document.getElementById('id_amount');
...
// {
    ...
    window.onload = function()
    {
        ...
        angle = $('#angle').val();
        draw();
        let partner = document.getElementById('id_detect_partner');
        let publisher = document.getElementById('id_detect_publisher');
        if (partner != null || publisher != null) {
          let msg = ''
          if (partner.value) {
            msg = '取引先';
          }
